 ...
 */
class Programacionsugeridadetalle extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Programacionsugeridadetalle the static model class
	 */
	...
	public function search()
	{
        ...
        public function generarProgramacionSugerida (){
