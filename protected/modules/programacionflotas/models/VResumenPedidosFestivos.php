...
/**
 * This is the model class for table "v_resumen_pedidos_festivos".
 *
 * The followings are the available columns in table 'v_resumen_pedidos_festivos':
...
class VResumenPedidosFestivos extends CActiveRecord
{
	 ...
	 * @return VResumenPedidosFestivos the static model class
	 */
	...
	{
		return 'v_resumen_pedidos_festivos';
	}
