 ...
 * @property Reportepedidosxpdv[] $hReportepedidosxpdvs
 * @property Diasclientefiel[] $mDiasclientefiels
 * @property Sedes $idSede
 * @property Horarioxflota[] $mHorarioxflotas
 * @property Mensajeros[] $mMensajeroses
 */
class Flotas extends CActiveRecord
{
        public $sede;
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Flotas the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'hReportepedidosxpdvs' => array(self::HAS_MANY, 'Reportepedidosxpdv', 'IdFlota'),
			'mDiasclientefiels' => array(self::HAS_MANY, 'Diasclientefiel', 'IdFlota'),
			'idSede' => array(self::BELONGS_TO, 'Sedes', 'IdSede'),
			'mHorarioxflotas' => array(self::HAS_MANY, 'Horarioxflota', 'IdFlota'),
			'mMensajeroses' => array(self::HAS_MANY, 'Mensajeros', 'IdFlota'),
		);
	}
