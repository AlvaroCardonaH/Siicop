 ...
 */
class ResumenClasificacionDias extends CActiveRecord
{
        public $BuscarDia;
        public $BuscarHora;
	/**
	 ...
	 * @return ResumenClasificacionDias the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('IdReportePedidosxPdv, IdClasificacionDia, BuscarDia, FactorDeAtencion, BuscarHora, NumeroPosicion, IdHorario, HoraInicio, HoraFinal, Lunes_Servicios, Numero_Mensajeros_Lunes, Martes_Servicios, Numero_Mensajeros_Martes, Miercoles_Servicios, Numero_Mensajeros_Miercoles, Jueves_Servicios, Numero_Mensajeros_Jueves, Viernes_Servicios, Numero_Mensajeros_Viernes, Sabado_Servicios, Numero_Mensajeros_Sabado, Domingo_Servicios, Numero_Mensajeros_Domingo, ClienteFiel_Servicios, Numero_Mensajeros_ClienteFiel, Promedio_Mensajeros_Hora_Normal, Promedio_Mensajeros_Hora_Festivo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('t.FactorDeAtencion',$this->FactorDeAtencion);
