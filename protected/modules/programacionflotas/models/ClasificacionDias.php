 ...
 * @property Diassemana[] $mDiassemanas
 */
class Clasificaciondias extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Clasificaciondias the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'mDiassemanas' => array(self::HAS_MANY, 'Diassemana', 'IdClasificacionDia'),
		);
	}
