...
class ReportepedidosxpdvdetalleController extends Controller
{
	/**
	...
	{
		$model=new Reportepedidosxpdvdetalle;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Reportepedidosxpdvdetalle']))
		{
			$model->attributes=$_POST['Reportepedidosxpdvdetalle'];
			if($model->save())
	...
	public function actionIndex()
	{
            ...
            $criteria = new CDbCriteria();            
                ...
                $model=new Reportepedidosxpdvdetalle('search');
                $model->unsetAttributes();  // clear any default values

                if(isset($_GET['Reportepedidosxpdvdetalle']))
		{
                        $model->attributes=$_GET['Reportepedidosxpdvdetalle'];
                    ...
                    $session['Reportepedidosxpdvdetalle_records']=Reportepedidosxpdvdetalle::model()->findAll($criteria); 
		}
	...
	{
		$model=Reportepedidosxpdvdetalle::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='Reportepedidosxpdvdetalle-form')
		{
