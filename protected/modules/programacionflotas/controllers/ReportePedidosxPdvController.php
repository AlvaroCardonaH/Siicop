...
class ReportepedidosxpdvController extends Controller
{
	/**
	...
	{
		$model=new Reportepedidosxpdv;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['Reportepedidosxpdv']))
		{
			$model->attributes=$_POST['Reportepedidosxpdv'];
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Reportepedidosxpdv']))
		{
                    ...
                    $session['Reportepedidosxpdv_records']=Reportepedidosxpdv::model()->findAll($criteria); 
		}
	...
	{
		$model=Reportepedidosxpdv::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='Reportepedidosxpdv-form')
		{
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Reportepedidosxpdv_records']))
               {
                $model=$session['Reportepedidosxpdv_records'];
               }
               else
                 $model = Reportepedidosxpdv::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Reportepedidosxpdv Report');
		$pdf->SetSubject('Reportepedidosxpdv Report');
		...
		$pdf->LastPage();
		$pdf->Output("Reportepedidosxpdv_002.pdf", "I");
	}
}
