...
class DiassemanaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Diassemana'];
			if($model->save())
		...
		$this->render('create',array(
			'model'=>$model,
                ...
                $this->redirect(Yii::app()->request->baseUrl."/Diassemana/index");
	}
	...
	public function actionIndex()
	{
            ...
            $criteria = new CDbCriteria();            
                ...
                $model=new Diassemana('search');
                $model->unsetAttributes();  // clear any default values

                if(isset($_GET['Diassemana']))
		{
                        $model->attributes=$_GET['Diassemana'];
                    ...
                    $session['Diassemana_records']=Diassemana::model()->findAll($criteria); 
		}
	...
	{
		$model=Diassemana::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='Diassemana-form')
		{
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Diassemana_records']))
               {
                $model=$session['Diassemana_records'];
               }
               else
                 $model = Diassemana::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Diassemana Report');
		$pdf->SetSubject('Diassemana Report');
		...
		$pdf->LastPage();
		$pdf->Output("Diassemana_002.pdf", "I");
	}
}
