...
class FlotasController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Flotas']))
		{
			$model->attributes=$_POST['Flotas'];
	...
	public function actionIndex()
	{
            ...
            $criteria = new CDbCriteria();            
                ...
                $model=new Flotas('search');
                $model->unsetAttributes();  // clear any default values

                if(isset($_GET['Flotas']))
		{
                        $model->attributes=$_GET['Flotas'];
                    ...
                    $session['Flotas_records']=Flotas::model()->findAll($criteria); 
		}
	...
	{
		$model=Flotas::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='Flotas-form')
		{
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Flotas_records']))
               {
                $model=$session['Flotas_records'];
               }
               else
                 $model = Flotas::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Flotas Report');
		$pdf->SetSubject('Flotas Report');
