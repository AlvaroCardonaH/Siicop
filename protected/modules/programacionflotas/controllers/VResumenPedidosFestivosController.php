...
class VResumenPedidosFestivosController extends Controller
{
	/**
	...
	{
		$model=new VResumenPedidosFestivos;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['VResumenPedidosFestivos']))
		{
			$model->attributes=$_POST['VResumenPedidosFestivos'];
			if($model->save())
	...
	public function actionIndex()
	{
            ...
            $criteria = new CDbCriteria();            
                ...
                $model=new VResumenPedidosFestivos('search');
                $model->unsetAttributes();  // clear any default values

                if(isset($_GET['VResumenPedidosFestivos']))
		{
                        $model->attributes=$_GET['VResumenPedidosFestivos'];
	...
	{
		$model=VResumenPedidosFestivos::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='vresumen-pedidos-festivos-form')
		{
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['VResumenPedidosFestivos_records']))
               {
                $model=$session['VResumenPedidosFestivos_records'];
               }
               else
                 $model = VResumenPedidosFestivos::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('VResumenPedidosFestivos Report');
		$pdf->SetSubject('VResumenPedidosFestivos Report');
		...
		$pdf->LastPage();
		$pdf->Output("VResumenPedidosFestivos_002.pdf", "I");
	}
}
