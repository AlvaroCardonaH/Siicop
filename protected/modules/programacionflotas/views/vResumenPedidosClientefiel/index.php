...
<h4>Presione clic en Ver Detalle para ver el resumen de pedidos por dia cliente fiel: </h4>
<hr />
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	'id'=>'vresumen-pedidos-cliente-fiel-grid',
	...
	'columns'=>array(
		...
		*/
            array(
                    'class'=>'CLinkColumn',
                    'label'=>'Ver Detalle',
                    'urlExpression'=>'Yii::app()->createUrl("programacionflotas/VResumenPedidosClientefiel/admin",array("id"=>$data->IdReportePedidosxPdv,"fechainicio"=>$data->FechaInicio,"fechafinal"=>$data->FechaFinal,"flota"=>$data->idFlota->NombreFlota))',
                    'header'=>'Detalle'
                 ),
	),
)); ?>
