...
$('.search-form form').submit(function(){
    $.fn.yiiGridView.update('vresumen-pedidos-festivo-grid', {
        data: $(this).serialize()
    });
    return false;
});
...
<h4>Presione clic en Ver Detalle para ver el resumen de pedidos por dia festivo: </h4>
<hr />
	...
	'columns'=>array(
		...
		*/
            array(
                    'class'=>'CLinkColumn',
                    'label'=>'Ver Detalle',
                    'urlExpression'=>'Yii::app()->createUrl("programacionflotas/VResumenPedidosFestivos/admin",array("id"=>$data->IdReportePedidosxPdv,"fechainicio"=>$data->FechaInicio,"fechafinal"=>$data->FechaFinal,"flota"=>$data->idFlota->NombreFlota))',
                    'header'=>'Detalle'
                 ),
	),
)); ?>
