...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
   ...
   <div class="control-group">		
	...
	<?php echo $form->textFieldRow($model,'LoginUsuario',array('class'=>'span5','maxlength'=>20, 'style'=>'text-transform:uppercase', 'onKeyUp'=>'javascript:this.value=this.value.toUpperCase();')); ?>

	<?php echo $form->passwordFieldRow($model,'ContrasenaUsuario',array('class'=>'span5','maxlength'=>50)); ?>
