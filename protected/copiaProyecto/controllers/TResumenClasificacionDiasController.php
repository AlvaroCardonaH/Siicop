...
class TResumenClasificacionDiasController extends Controller
{
	/**
	...
	{
		$model=new TResumenClasificacionDias;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['TResumenClasificacionDias']))
		{
			$model->attributes=$_POST['TResumenClasificacionDias'];
			if($model->save())
	...
	public function actionIndex()
	{
            ...
            $criteria = new CDbCriteria();            
                ...
                $model=new TResumenClasificacionDias('search');
                $model->unsetAttributes();  // clear any default values

                if(isset($_GET['TResumenClasificacionDias']))
		{
                        $model->attributes=$_GET['TResumenClasificacionDias'];
                    ...
                    $session['TResumenClasificacionDias_records']=TResumenClasificacionDias::model()->findAll($criteria); 
		}
	...
	{
		$model=TResumenClasificacionDias::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tresumen-clasificacion-dias-form')
		{
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['TResumenClasificacionDias_records']))
               {
                $model=$session['TResumenClasificacionDias_records'];
               }
               else
                 $model = TResumenClasificacionDias::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('TResumenClasificacionDias Report');
		$pdf->SetSubject('TResumenClasificacionDias Report');
		...
		$pdf->LastPage();
		$pdf->Output("TResumenClasificacionDias_002.pdf", "I");
	}
}
