...
class TProgramacionsugeridadetalleController extends Controller
{
	/**
	...
	public function actionIndex()
	{
            ...
            $criteria = new CDbCriteria();            
                ...
                $model=new TProgramacionsugeridadetalle('search');
                $model->unsetAttributes();  // clear any default values

                if(isset($_GET['TProgramacionsugeridadetalle']))
		{
                        $model->attributes=$_GET['TProgramacionsugeridadetalle'];
                    ...
                    $session['TProgramacionsugeridadetalle_records']=TProgramacionsugeridadetalle::model()->findAll($criteria); 
		}
	...
	public function actionAdmin($id)
	{
		$model=new TProgramacionsugeridadetalle;
		 ...
		 if(isset($_POST['TProgramacionsugeridadetalle']))
		 {
                     ...
                     $array_detallelista=$_POST['TProgramacionsugeridadetalle'];
	...
	{
		$model=TProgramacionsugeridadetalle::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tprogramacionsugeridadetalle-form')
		{
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['TProgramacionsugeridadetalle_records']))
               {
                $model=$session['TProgramacionsugeridadetalle_records'];
               }
               else
                 $model = TProgramacionsugeridadetalle::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('TProgramacionsugeridadetalle Report');
		$pdf->SetSubject('TProgramacionsugeridadetalle Report');
		...
		$pdf->LastPage();
		$pdf->Output("TProgramacionsugeridadetalle_002.pdf", "I");
	}
}
