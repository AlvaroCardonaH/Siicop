...
class MFlotasController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['MFlotas']))
		{
			$model->attributes=$_POST['MFlotas'];
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->IdFlota));
		}
	...
	public function actionIndex()
	{
            ...
            $criteria = new CDbCriteria();            
                ...
                $model=new MFlotas('search');
                $model->unsetAttributes();  // clear any default values

                if(isset($_GET['MFlotas']))
		{
                        $model->attributes=$_GET['MFlotas'];
                    ...
                    $session['MFlotas_records']=MFlotas::model()->findAll($criteria); 
		}
	...
	{
		$model=MFlotas::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mflotas-form')
		{
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['MFlotas_records']))
               {
                $model=$session['MFlotas_records'];
               }
               else
                 $model = MFlotas::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('MFlotas Report');
		$pdf->SetSubject('MFlotas Report');
