...
class MHorarioController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['MHorario']))
		{
			$model->attributes=$_POST['MHorario'];
	...
	public function actionIndex()
	{
            ...
            $criteria = new CDbCriteria();            
                ...
                $model=new MHorario('search');
                $model->unsetAttributes();  // clear any default values

                if(isset($_GET['MHorario']))
		{
                        $model->attributes=$_GET['MHorario'];
                    ...
                    $session['MHorario_records']=MHorario::model()->findAll($criteria); 
		}
	...
	{
		$model=MHorario::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mhorario-form')
		{
