 ...
 * @property HReportepedidosxpdvdetalle[] $hReportepedidosxpdvdetalles
 */
class HReportepedidosxpdv extends CActiveRecord
{
        public $flota;
        public $archivo;
	/**
	 ...
	 * @return HReportepedidosxpdv the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			...
			'hReportepedidosxpdvdetalles' => array(self::HAS_MANY, 'HReportepedidosxpdvdetalle', 'IdReportePedidosxPdv'),
		);
	}
