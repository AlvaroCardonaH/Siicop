	...
	'columns'=>array(
		...
		*/
            array(
                    'class'=>'CLinkColumn',
                    'label'=>'Ver Detalle',
                    'urlExpression'=>'Yii::app()->createUrl("TResumenclasificaciondias/admin",array("id"=>$data->IdReportePedidosxPdv,"fechainicio"=>$data->FechaInicio,"fechafinal"=>$data->FechaFinal,"flota"=>$data->idFlota->NombreFlota))',
                    'header'=>'Detalle'
                 ),
	),
)); ?>
