<?php  $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
        'id'=>'search-vresumen-pedidos-festivos-form',
	...
	<?php echo $form->textFieldRow($model,'NombreClasificacionDia',array('class'=>'span5','maxlength'=>45)); ?>
	...
	<?php echo $form->textFieldRow($model,'NumeroDiaSemana',array('class'=>'span5')); ?>
...
?>	
   <script>
	$(".btnreset").click(function(){
		$(":input","#search-vresumen-pedidos-festivos-form").each(function() {
		var type = this.type;
