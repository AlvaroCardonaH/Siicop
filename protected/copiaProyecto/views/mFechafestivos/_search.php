<?php  $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
        'id'=>'search-mfechafestivos-form',
	'action'=>Yii::app()->createUrl($this->route),
	'method'=>'get',
));  ?>


	<?php echo $form->textFieldRow($model,'IdFechaFestivo',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'FechaFestivo',array('class'=>'span5')); ?>
...
?>	
   <script>
	$(".btnreset").click(function(){
		$(":input","#search-mfechafestivos-form").each(function() {
		var type = this.type;
