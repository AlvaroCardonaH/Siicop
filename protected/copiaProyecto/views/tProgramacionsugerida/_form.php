...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
   ...
   <div class="control-group">		
        ...
        <?php echo $form->dropDownListRow(
                    ...
                    CHtml::listData(HReportepedidosxpdv::model()->findAll(), 'IdReportePedidosxPdv', 'DescripcionReporte'),
	...
	<?php echo $form->dropDownListRow(
                    $model,
                    'IdClasificacionDia',
                    CHtml::listData(MClasificaciondias::model()->findAll(), 'IdClasificacionDia', 'NombreClasificacionDia'),
                    array('empty'=>'', 'class'=>'span5')
        ...
        <?php echo $form->dropDownListRow(
                    $model,
                    'IdFlota',
                    CHtml::listData(MFlotas::model()->findAll(array('order'=>'NombreFlota')), 'IdFlota', 'NombreFlota'),
                    array('empty'=>'', 'class'=>'span5')
