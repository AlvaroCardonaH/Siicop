<?php
$this->setPageTitle('Ver Reporte Pedido');
...
<h1>Ver Reporte Pedido: <?php echo $model->IdReportePedidosxPdv; ?></h1>
<hr />
<?php 
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
		//array('label'=>'Create', 'icon'=>'icon-plus', 'url'=>Yii::app()->controller->createUrl('create'), 'linkOptions'=>array()),
                ...
                //array('label'=>'Actualizar', 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->IdReportePedidosxPdv)), 'linkOptions'=>array()),
