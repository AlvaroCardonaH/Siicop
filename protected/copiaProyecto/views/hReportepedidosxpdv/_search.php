<?php  $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
        'id'=>'search-hreportepedidosxpdv-form',
	...
	<?php echo $form->textFieldRow($model,'CodigoEstadoReporte',array('class'=>'span5')); ?>
...
?>	
   <script>
	$(".btnreset").click(function(){
		$(":input","#search-hreportepedidosxpdv-form").each(function() {
		var type = this.type;
