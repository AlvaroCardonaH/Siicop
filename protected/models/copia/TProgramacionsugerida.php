 ...
 */
class TProgramacionsugerida extends CActiveRecord
{
        public $BuscarFlota;
        public $BuscarDia;
        public $IdFlota;
	 ...
	 * @return TProgramacionsugerida the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
                    'idReportexpdv'=>array(self::BELONGS_TO,'HReportepedidosxpdv','IdReportePedidosxPdv'),                  
