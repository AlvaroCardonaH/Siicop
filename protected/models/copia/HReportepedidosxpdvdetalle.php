 ...
 */
class HReportepedidosxpdvdetalle extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return HReportepedidosxpdvdetalle the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'idReportePedidosxPdv' => array(self::BELONGS_TO, 'HReportepedidosxpdv', 'IdReportePedidosxPdv'),
		);
	}
