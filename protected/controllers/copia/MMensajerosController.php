...
class MMensajerosController extends Controller
{
	/**
	...
	{
		$model=new MMensajeros;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['MMensajeros']))
		{
			$model->attributes=$_POST['MMensajeros'];
	...
	public function actionIndex()
	{
            ...
            $criteria = new CDbCriteria();            
                ...
                $model=new MMensajeros('search');
                $model->unsetAttributes();  // clear any default values

                if(isset($_GET['MMensajeros']))
		{
                        $model->attributes=$_GET['MMensajeros'];
                    ...
                    $session['MMensajeros_records']=MMensajeros::model()->findAll($criteria); 
		}
	...
	{
		$model=MMensajeros::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mmensajeros-form')
		{
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['MMensajeros_records']))
               {
                $model=$session['MMensajeros_records'];
               }
               else
                 $model = MMensajeros::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('MMensajeros Report');
		$pdf->SetSubject('MMensajeros Report');
		...
		$pdf->LastPage();
		$pdf->Output("MMensajeros_002.pdf", "I");
	}
}
