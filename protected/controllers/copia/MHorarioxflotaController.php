...
class MHorarioxflotaController extends Controller
{
	/**
	...
	{
		$model=new MHorarioxflota;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['MHorarioxflota']))
		{
			$model->attributes=$_POST['MHorarioxflota'];
                        
                        $Flota = $model->IdFlota;
                        $HoraInicio = $_POST['MHorarioxflota']['HoraInicio'];
                        $HoraFinal = $_POST['MHorarioxflota']['HoraFinal'];
	...
	public function actionIndex()
	{
            ...
            $criteria = new CDbCriteria();            
                ...
                $model=new MHorarioxflota('search');
                $model->unsetAttributes();  // clear any default values

                if(isset($_GET['MHorarioxflota']))
		{
                        $model->attributes=$_GET['MHorarioxflota'];
                    ...
                    $session['MHorarioxflota_records']=MHorarioxflota::model()->findAll($criteria); 
		}
	...
	{
		$model=MHorarioxflota::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mhorarioxflota-form')
		{
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['MHorarioxflota_records']))
               {
                $model=$session['MHorarioxflota_records'];
               }
               else
                 $model = MHorarioxflota::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('MHorarioxflota Report');
		$pdf->SetSubject('MHorarioxflota Report');
		...
		$pdf->LastPage();
		$pdf->Output("MHorarioxflota_002.pdf", "I");
	}
}
