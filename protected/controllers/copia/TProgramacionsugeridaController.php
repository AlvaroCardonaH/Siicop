...
class TProgramacionsugeridaController extends Controller
{
	/**
	...
	{
		$model=new TProgramacionsugerida;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['TProgramacionsugerida']))
		{
			$model->attributes=$_POST['TProgramacionsugerida'];
	...
	public function actionIndex()
	{
            ...
            $criteria = new CDbCriteria();            
                ...
                $model=new TProgramacionsugerida('search');
                $model->unsetAttributes();  // clear any default values

                if(isset($_GET['TProgramacionsugerida']))
		{
                        $model->attributes=$_GET['TProgramacionsugerida'];
                    ...
                    $session['TProgramacionsugerida_records']=TProgramacionsugerida::model()->findAll($criteria); 
		}
	...
	{
		$model=TProgramacionsugerida::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tprogramacionsugerida-form')
		{
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['TProgramacionsugerida_records']))
               {
                $model=$session['TProgramacionsugerida_records'];
               }
               else
                 $model = TProgramacionsugerida::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('TProgramacionsugerida Report');
		$pdf->SetSubject('TProgramacionsugerida Report');
		...
		$pdf->LastPage();
		$pdf->Output("TProgramacionsugerida_002.pdf", "I");
	}
}
