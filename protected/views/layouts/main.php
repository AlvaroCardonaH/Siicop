            ...
            'items'=>array(
                array('label'=>'Programacion Turnos Flota', 'url'=>array('/programacionflotas')),
					...
					array('label'=>'Gestionar Resumen pedidos por tipo de dia', 'url'=>'#', 'itemOptions' => array('class' => 'dropdown-submenu'),
                                    'submenuOptions' => array('class' => 'dropdown-menu'),
                                    'items' => array(
                                                    array('label' => 'Resumen pedidos dia normal', 'url' => array('programacionflotas/vResumenPedidosNormal')),
                                                    array('label' => 'Resumen pedidos dia festivo', 'url' => array('programacionflotas/vResumenPedidosFestivos')),
                                                    array('label' => 'Resumen pedidos dia cliente fiel', 'url' => array('programacionflotas/vResumenPedidosClientefiel')),
