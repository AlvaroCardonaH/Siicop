...
$this->widget('bootstrap.widgets.TbBreadcrumbs', array(
    'links' => array(
        'Programacion Sugerida'=>array('TProgramacionsugerida/index'),
...
$this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		array(
		  ...
		  'header'=>'Hora 23', 
                  'type'=>'raw',
                  'value'=>'CHtml::dropDownList("TProgramacionsugeridadetalle[$data->IdProgramacionSugeridaDetalle][]",$data->HoraVeintiTres, array("0"=>"0","1"=>"1"),array("class"=>($data->HoraVeintiTres=="1") ? "yellow" : "white"))',
