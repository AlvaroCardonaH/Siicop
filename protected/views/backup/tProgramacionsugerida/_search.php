<?php  $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
        'id'=>'search-tprogramacionsugerida-form',
	...
	<?php echo $form->textFieldRow($model,'DescripcionProgramacionSugerida',array('class'=>'span5','maxlength'=>2000)); ?>
...
?>	
   <script>
	$(".btnreset").click(function(){
		$(":input","#search-tprogramacionsugerida-form").each(function() {
		var type = this.type;
