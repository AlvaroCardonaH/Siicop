...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		...
		array(
                    ...
                    'label'=>'Ver Detalle',
                    'htmlOptions'=>array('style'=>'width: 80px; text-align: center;'),
                    'urlExpression'=>'Yii::app()->createUrl("TProgramacionsugeridadetalle/admin",array("id"=>$data->IdProgramacionSugerida,"fechainicio"=>$data->FechaInicio,"fechafinal"=>$data->FechaFinal,"idreporte"=>$data->IdReportePedidosxPdv,"dia"=>$data->IdClasificacionDia))',
                    'header'=>'Detalle'
                 ),
           /* array(
