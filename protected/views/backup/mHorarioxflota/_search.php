<?php  $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
        'id'=>'search-mhorarioxflota-form',
	'action'=>Yii::app()->createUrl($this->route),
	'method'=>'get',
));  ?>


	<?php echo $form->textFieldRow($model,'IdHorarioxFlota',array('class'=>'span5')); ?>
	...
	<?php echo $form->textFieldRow($model,'EstaHabilitada',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'EsHoraPico',array('class'=>'span5')); ?>
...
?>	
   <script>
	$(".btnreset").click(function(){
		$(":input","#search-mhorarioxflota-form").each(function() {
		var type = this.type;
